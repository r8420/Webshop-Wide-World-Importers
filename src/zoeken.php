                ...
                <ul class="list-group list-group-flush text-dark" id="productList">
                    ...
                    if ($numResults > 0) {
                        ...
                        for ($i = 0; $i < count($resultArray) && $i < abs(($page - 1) * $itemsPerPage - $numResults); $i++) {
                            ...
                            print('<li class="list-group-item shadow"><a href="product.php?product=' . $resultArray[$i]['StockItemID'] . '"><img alt="Artikel foto" src="data:image/jpeg;base64,' . $productPhoto . '" width="190" height="120"><span class="col-8">' . $productName . '</span><span class="col-4">' . '€ ' . $productPrice . '</span></a>');
                            ?>
