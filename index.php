                ...
                foreach ($productsSlider AS $product) {
                    ...
                    $active = ""; ?>">
                        ...
                        <div class="carousel-caption">
                            ...
                            <a href="Pages/product_pagina.php?product=<?php echo $product[2]; ?>">
        ...
        if ($products != null) {
            foreach($products AS $product) {
                ...
                <div class="col-sm-3 col-md-3">
                    <a href="Pages/product_pagina.php?product=<?php echo $product[0]; ?>"
    ...
    <div class="row mt-5">
        ...
        if ($categorieProducts != null) {
            foreach ($categorieProducts as $product) {
                ?>
                <div class="col-sm-3">
                    <a href="Pages/zoekpagina.php?category=<?php echo $product[3]; ?>"
                       class="text-decoration-none">
